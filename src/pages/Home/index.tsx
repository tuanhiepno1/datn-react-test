    ...
    return (
        <Layout>
            ...
            <Content style={{ padding: '0 50px' }}>
                ...
                <div style={{ marginTop: '20px', backgroundColor: '#f0f0f0', padding: '20px 0' }}>
                    <Row gutter={[16, 16]} justify="center">
                        <Col span={4}>
                            <Card
                                hoverable
                                style={{ textAlign: 'center', backgroundColor: '#fffbea', borderRadius: '8px' }}
                            >
                                <AppstoreOutlined style={{ fontSize: '40px', color: '#fadb14' }} />
                        ...
                        <Col span={4}>
                            <Card
                                ...
                                style={{ textAlign: 'center', backgroundColor: '#fffbea', borderRadius: '8px' }}
                            >
                                <CarOutlined style={{ fontSize: '40px', color: '#fadb14' }} />
                        ...
                        <Col span={4}>
                            <Card
                                ...
                                style={{ textAlign: 'center', backgroundColor: '#fffbea', borderRadius: '8px' }}
                            >
                                <ReloadOutlined style={{ fontSize: '40px', color: '#fadb14' }} />
                        ...
                        <Col span={4}>
                            <Card
                                ...
                                style={{ textAlign: 'center', backgroundColor: '#fffbea', borderRadius: '8px' }}
                            >
                                <SafetyOutlined style={{ fontSize: '40px', color: '#fadb14' }} />
                        ...
                        <Col span={4}>
                            <Card
                                ...
                                style={{ textAlign: 'center', backgroundColor: '#fffbea', borderRadius: '8px' }}
                            >
                                <CreditCardOutlined style={{ fontSize: '40px', color: '#fadb14' }} />
                ...
                <div style={{ padding: '20px 0' }}>
                    <h2 style={{ textAlign: 'center', fontSize: '40px', fontWeight: 'bold', marginBottom: 20 }}>Sản phẩm hot</h2>
                    <Row gutter={[16, 16]}>
                        <Col span={6}>
                            <Card
                                bordered={true}
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={16}>
                            <div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '16px' }}>
                                ...
                                />
                                <h3 style={{ fontSize: '24px', marginTop: '16px' }}>Định nghĩa về người đàn ông lịch lãm và những món phụ kiện không thể thiếu</h3>
                            ...
                            <Row gutter={[16, 16]}>
                                <Col span={24}>
                                    <div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '16px', display: 'flex' }}>
                                        ...
                                        />
                                        <div>
                                            <h4 style={{ fontSize: '18px', margin: '0 0 8px' }}>Muốn dậy lúc 5h sáng thì ngủ lúc mấy giờ là tốt nhất?</h4>
                                ...
                                <Col span={24}>
                                    <div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '16px', display: 'flex' }}>
                                        ...
                                        />
                                        <div>
                                            <h4 style={{ fontSize: '18px', margin: '0 0 8px' }}>Dịch vụ mạ vàng đồng hồ</h4>
                                            <p style={{ fontSize: '14px', margin: 0 }}>
                                ...
                                <Col span={24}>
                                    <div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '16px', display: 'flex' }}>
                                        ...
                                        />
                                        <div>
                                            <h4 style={{ fontSize: '18px', margin: '0 0 8px' }}>Muốn dậy từ 4h sáng mà vẫn khỏe mạnh, bạn nên đi ngủ từ lúc nào?</h4>
                                            <p style={{ fontSize: '14px', margin: 0 }}>
                                ...
                                <Col span={24}>
                                    <div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '16px', display: 'flex' }}>
                                        ...
                                        />
                                        <div>
                                            <h4 style={{ fontSize: '18px', margin: '0 0 8px' }}>Xem giờ nước lên xuống trong ngày đơn giản với đồng hồ thủy triều</h4>
                                            <p style={{ fontSize: '14px', margin: 0 }}>
